...
class GAMNED_UAE:
  ...
  def get_age_data(self):
    ...
    col1 = ['instagram', 'facebook', 'linkedin', 'snapchat', 'youtube', 'tiktok', 'twitter', 'twitch', 'display', 'in game advertising',
           'connected tv']
    col2 = [8, 4.7, 0, 20, 0, 25, 7.8, 20, 14, 25, 5]
    col3 = [31, 21.5, 21.7, 38.8, 15, 33.8, 25.2, 21, 31, 30, 10]
    col4 = [30, 34.3, 60, 22.8, 20.7, 22.8, 26.6, 32, 27, 15, 15]
    col5 = [16, 19.3, 10, 13.8, 16.7, 13.8, 28.4, 17, 15, 5, 20]
    col6 = [8, 11.6, 5.4, 3.8, 11.9, 3.8, 8, 7, 7, 5, 30]
    col7 = [4, 7.2, 2.9, 0, 8.8, 0, 4, 3, 3, 0, 25]
    col8 = [3, 5.6, 0, 0, 9, 0, 0, 0, 2, 0, 25]
