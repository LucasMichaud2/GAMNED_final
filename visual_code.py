 ...
 with st.container():
     st.markdown(
         ...
         .heatmap-item {
             ...
             border-radius: 10px;
             box-shadow: 0 0 10px rgba(0, 0, 0, 1.5), -5px -5px 15px 10px rgba(255, 255, 255, 0.8); 
         ...
         .heatmap-item::before {
            ...
            right: 0px;
            bottom: 0px;
            box-shadow: 0 0 1px rgba(0, 0, 0, 0.7) inset, 0 0 30px rgba(0, 0, 0, 0.12) inset; /* Add an inset shadow for 3D effect */
