...
class GAMNED_UAE:
  ...
  def get_age_data(self):
    ...
    col5 = [16, 19.3, 10, 13.8, 16.7, 13.8, 28.4, 17, 15, 5, 20, 30, 15]
    col6 = [8, 11.6, 20, 3.8, 11.9, 3.8, 8, 7, 7, 0, 30, 30, 15]
    col7 = [4, 7.2, 2.9, 0, 8.8, 0, 4, 3, 3, 0, 25, 20, 20]
    col8 = [-5, 5.6, 0, 0, 9, 0, 0, 0, 2, -10, 40, 30, 20]
